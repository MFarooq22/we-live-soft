  ...
  function setFormFields(data) {
    ...
    projects.forEach((project) => {
        ...
        <label for="projecttitle">Project Title:</label>
            ...
            <img src="http://we-live-soft.vercel.app/public/images/${project.image}" style="max-width: 180px;" alt="Resume" ><br><br>
...
async function sendDataToServer() {
    ...
    try {
        const response = await fetch('http://we-live-soft.vercel.app/api/portfolio', {
            method: 'POST',
