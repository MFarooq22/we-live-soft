  ...
  function setFormFields(data) {
    ...
    <img src="http://we-live-soft.vercel.app/public/images/${logoImage}" style="max-width: 180px;" alt="Resume" ><br><br>
...
menuForm.addEventListener("submit", async (event) => {
    ...
    try {
        const response = await fetch('http://we-live-soft.vercel.app/api/menu', {
            method: 'POST',
            body: formData,
        });
